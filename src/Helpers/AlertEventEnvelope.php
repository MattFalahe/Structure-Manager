...
final class AlertEventEnvelope
{
    ...
    private const CATEGORY_GROUPS = [
        ...
        // 2026-05-12: tactical-planning events added for the Discord Pings
        // calendar integration. Anchoring is 'lifecycle' because it's a
        // structure-lifecycle event (a new structure appearing), but it
        // still carries a future timer that fleet planners care about.
        // Sov reinforce / entosis are 'tactical' (alliance defense ops).
        'anchoring_started'    => 'lifecycle',
        'sov_reinforced'       => 'tactical',
        'entosis_in_progress'  => 'tactical',
    ];
