...
<style>
    /* === Structure Board Grid — page-specific chrome ===
       The 6×7 calendar grid layout, day-cell states (outside-month,
       is-today), event blocks, severity stripes and category-group
       tints. Generic card/button/alert styling now comes from canonical
       structure-manager.css. */
    ...
    /* Calendar cell — fixed-height grid layout primitive. */
    .cb-grid-cell {
        vertical-align: top;
        height: 110px;
        padding: 6px;
    ...
    /* SEMANTIC: dim treatment for days outside the requested month */
    .cb-grid-cell.outside-month {
        background: #1f242c;
        opacity: 0.5;
    }

    /* SEMANTIC: highlight today's cell */
    ...
    /* Event block inside a day cell — small, single-line, ellipsified. */
    .cb-grid-event {
        display: block;
        font-size: 11px;
        padding: 2px 6px;
    ...
    /* SEMANTIC severity left-stripes — DO NOT CHANGE */
    ...
    /* SEMANTIC category-group tints — DO NOT CHANGE */
