                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <dl class="row">
                            ...
                            <dd class="col-sm-6">~{{ number_format($fuelBlocks['current_quantity'] * 5) }} m³</dd>
                            
                            <dt class="col-sm-6">Runs Out:</dt>
                            <dd class="col-sm-6">{{ \Carbon\Carbon::now()->addDays($fuelBlocks['days_remaining'])->format('Y-m-d H:i') }}</dd>
                            
                            <dt class="col-sm-6">Days Left:</dt>
                            @php
                                $fuelDays = floor($fuelBlocks['days_remaining']);
                                $fuelHours = floor(($fuelBlocks['days_remaining'] - $fuelDays) * 24);
                                $fuelColorClass = $fuelBlocks['days_remaining'] < 7 ? 'text-danger-bright' : ($fuelBlocks['days_remaining'] < 14 ? 'text-warning-bright' : 'text-success-bright');
                            @endphp
                    ...
                    <div class="col-md-6">
                        ...
                        <dl class="row">
                            ...
                            <dt class="col-sm-6">Volume:</dt>
                            <dd class="col-sm-6">~{{ number_format($magmaticGas['current_quantity'] * 0.01) }} m³</dd>
                            
                            <dt class="col-sm-6">Runs Out:</dt>
                            <dd class="col-sm-6">{{ \Carbon\Carbon::now()->addDays($magmaticGas['days_remaining'])->format('Y-m-d H:i') }}</dd>
                            
                            <dt class="col-sm-6">Days Left:</dt>
                            @php
                                $gasDays = floor($magmaticGas['days_remaining']);
                                $gasHours = floor(($magmaticGas['days_remaining'] - $gasDays) * 24);
                                $gasColorClass = $magmaticGas['days_remaining'] < 7 ? 'text-danger-bright' : ($magmaticGas['days_remaining'] < 14 ? 'text-warning-bright' : 'text-success-bright');
                            @endphp
