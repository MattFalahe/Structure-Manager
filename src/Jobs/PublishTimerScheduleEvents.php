...
/**
 * Family B scheduler — emits the three time-window-driven flavors of
 ...
 * structure_manager_timers (added in migration 000028). Each timer emits
 * each flavor at most once over its lifetime — even if the window remains
 * "open" across many job runs, the latch prevents re-emission.
 *
 ...
 * 55 and 60 min of warning instead of exactly 60). Acceptable for ops use.
 *
